    ...
    "data": [
        {
            ...
            "answer": "IBM Rational Rhapsody is a visual development environment used for modeling, designing, and generating code for embedded and real-time systems."
        },
        {
            "question": "How do I create a new project in Rhapsody?",
            "answer": "To create a new project in Rhapsody, go to the File menu, select 'New', and then choose 'Project'."
        }
    ]
}
